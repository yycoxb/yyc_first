...
from ultralytics.nn.modules import (
    ...
    C3k2_MutilScaleEdgeInformationSelect_CBAM,
    C3k2_MutilScaleEdgeInformationSelect_EMA,
    C3k2_EMA,
    AIFI,
    C1,
    C2,
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
           ...
           # print(args)
            ...
            args.insert(2, n)  # number of repeats
            n = 1
        elif m is C3k2_MutilScaleEdgeInformationSelect:
            c1 = ch[f]
            c2 = args[0]
            if c2 != nc:  # if c2 not equal to number of classes (i.e. for Classify() output)
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            ...
            args.insert(2, n)  # number of repeats
            n = 1
        elif m is C3k2_MutilScaleEdgeInformationSelect_CBAM:
            c1 = ch[f]
            c2 = args[0]
            if c2 != nc:  # if c2 not equal to number of classes (i.e. for Classify() output)
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            ...
            args.insert(2, n)  # number of repeats
            n = 1
        elif m is C3k2_MutilScaleEdgeInformationSelect_EMA:
            c1 = ch[f]
            c2 = args[0]
            if c2 != nc:  # if c2 not equal to number of classes (i.e. for Classify() output)
                c2 = make_divisible(min(c2, max_channels) * width, 8)
