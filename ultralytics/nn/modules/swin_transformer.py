...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
        ...
        self.dyt = DynamicTanh(normalized_shape=dim, channels_last=True)
    ...
    def forward(self, x, attn_mask):
        ...
        x = x + self.drop_path(self.mlp(self.dyt(x)))
...
class PatchMerging(nn.Module):
    ...
    def __init__(self, dim, c2, norm_layer=nn.LayerNorm):
        ...
        self.dyt = DynamicTanh(normalized_shape=4*dim, channels_last=True)
    def forward(self, x):
        """
        x: B, C, H, W
        """
