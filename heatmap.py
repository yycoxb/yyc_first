...
def get_params():
    params = {
        'weight': 'E:/wajueji_4k_results/yolo11s_asff_c3k2-mseis-EMA-4/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        ...
        'backward_type': 'class', # class, box, all"E:\wajueji_4k_results\yolo11s_asff_c3k2-mseis-EMA-4\weights\best.pt"
...
if __name__ == '__main__':
    ...
    model(r"D:\exacvator_nostrengthen\images\val", r"E:\CSMEF-YOLO-test\2")